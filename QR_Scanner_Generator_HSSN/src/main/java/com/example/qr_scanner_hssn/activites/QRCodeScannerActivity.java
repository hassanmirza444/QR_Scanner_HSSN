...
import com.example.qr_scanner_hssn.camera.CameraManager;
import com.example.qr_scanner_hssn.decoding.CaptureActivityHandler;
import com.example.qr_scanner_hssn.decoding.InactivityTimer;
import com.example.qr_scanner_hssn.view.ViewfinderView;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    protected void setUpCamera() {
        ...
        hasSurface = false;
        inactivityTimer = new InactivityTimer(QRCodeScannerActivity.this);
    }
    ...
    protected void setUpSurfaceAndSound() {
        ...
        if (hasSurface) {
            ...
            surfaceHolder.addCallback(QRCodeScannerActivity.this);
    ...
    public void onQrResult(String resultString) {
        if (resultString.equals("")) {
            Toast.makeText(QRCodeScannerActivity.this, "Scan Result Empty!", Toast.LENGTH_SHORT).show();
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(QRCodeScannerActivity.this, decodeFormats, characterSet);
        }
    }
